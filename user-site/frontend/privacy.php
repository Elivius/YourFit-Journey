...
<head>
    ...
    <title>Privacy Policy - YourFit Journey</title>
    ...
    <section class="hero-section">
        <div class="container">
            ...
            <div class="card shadow-lg border-0 rounded-4 p-4 p-md-5 bg-white">
                ...
                <p class="mb-2">Your privacy is important to us. This policy explains how we collect, use, and protect your information.</p>

                <hr>

                <h4 class="mb-3 mt-4">1. What We Collect</h4>
                <p class="mb-4">We collect information like your name, email, fitness stats, and profile picture to personalize your experience.</p>

                <h4 class="mb-3 mt-4">2. How We Use It</h4>
                <p class="mb-4">Your data is used only within YourFitJourney to help you reach your fitness goals. We never sell your data.</p>
                
                <h4 class="mb-3 mt-4">3. Security</h4>
                <p class="mb-4">All personal data is encrypted and stored securely. We follow best practices to protect your account.</p>
                
                <h4 class="mb-3 mt-4">4. Your Rights</h4>
                <p class="mb-4">You can request your data or deletion by emailing <a href="mailto:privacy@yourfitjourney.com">privacy@yourfitjourney.com</a>.</p>

                <h4 class="mb-3 mt-4">5. Cookies</h4>
                <p class="mb-4">We use cookies to remember login sessions and track feature usage to improve our service.</p>
            </div>
