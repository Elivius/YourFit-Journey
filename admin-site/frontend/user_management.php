        ...
        <div class="toolbar">
            <div class="toolbar-actions-left">
                ...
                <span style="position:relative; display:inline-block; margin-left:10px;">
                    ...
                    <input type="text" id="filterInput" placeholder="First or Last Name" style="padding:7px 32px 7px 34px; border-radius:8px; border:1.5px solid #d1d7fa; font-size:14px; transition:border-color 0.2s, box-shadow 0.2s;">
