...
$ingredientName = cleanInput($_POST['ingredientName']);
...
if (!$ingredientName || $protein === false || $carbs === false || $fats === false || $calories === false) {
...
if ($stmt = mysqli_prepare($connection, $sql_insert)) {
    mysqli_stmt_bind_param($stmt, "sdddd", $ingredientName, $protein, $carbs, $fats, $calories);
